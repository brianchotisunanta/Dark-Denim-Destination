angular
    ...
    .service("checkOutService", function() {
      ...
      var Customer = function (firstName, lastName, address1, address2, city, state, zipcode, email, password, phoneNumber, cardNumber, cardExpirationDate, cardSecurityCode) {
      ...
      _customers.push(new Customer("Donald", "Trump", "725 5th Avenue", "Floor 70", "New York" , "NY", "10022", "DonaldJTrump@whitehouse.com", "trumpone", "212-715-6788", "5789-3456-1234-0987", "07/21", "777"))

      _customers.push(new Customer("James", "Comey", "935 Pennsylvania Avenue, NW", "", "Washington", "D.C", "20535-0001", "JamesComey@fbi.com", "trumpfiredme", "202-324-3000", "1234-6534-2344-7564", "05/20", "555"))

      _customers.push(new Customer("Bobby", "Denim", "71751 Jeans Lane", "Suite 743", "Venice", "CA", "90291", "BobbyDenim@denimwearer.com", "ilovejeans", "310-454-7235", "8392-2957-5935-7921", "01/21", "111"))

      _customers.push(new Customer("Carson", "Daly", "1515 Broadway", "Suite 743", "New York", "NY", "10036", "CarsonDaly@mtv.com", "IWasAVJ", "212-846-6000", "1079-0352-5379-0017", "04/20", "454"))
